...
If you're trying to replicate these charts or any fancy `highcharter` attempts you see online I'd really recommend splitting the data manipulation and the chart code in your head. Oftentimes the data steps are reasonably complicated R code that takes you a while to get your head around. But if you assume you can create the data for a moment and just focus on what's happening in the chart logic I think it'll enhance your understanding of the `highcharter` code.
